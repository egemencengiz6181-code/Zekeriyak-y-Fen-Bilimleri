...
export default function Footer() {
  ...
  const socialLinks = [
    { icon: <Instagram className="w-5 h-5" />, href: "https://www.instagram.com/zekeriyakoyfenbilimleri/", label: "Instagram" },
  ];
  ...
  return (
    <footer className="relative bg-transparent z-10 pt-20">
      ...
      <div className="w-full h-[400px] relative overflow-hidden group">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3007.2038504773266!2d28.986540776342074!3d41.18918177132073!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14cafa01e1df521f%3A0x3d29a3c1cf3cec9!2sZekeriyak%C3%B6y%20Mah.%2C%20Kilyos%20Cd.%20No%3A238%2F2%2C%2034450%20Sar%C4%B1yer%2F%C4%B0stanbul!5e0!3m2!1str!2str!4v1741600000000!5m2!1str!2str"
          width="100%"
          height="100%"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3 text-foreground/40">
                  ...
                  <a href="mailto:zekeriyakoyfenbilimleri@gmail.com" className="hover:text-white transition-colors">
              ...
              <div className="flex flex-col justify-end">
                <a 
                  href="tel:+902122015848" 
                  className="inline-flex items-center gap-2 text-primary font-medium group"
                >
                  <span>0212 201 58 48</span>
