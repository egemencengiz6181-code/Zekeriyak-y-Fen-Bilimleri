  ...
  return (
    <section className="w-full h-[450px] relative overflow-hidden group bg-background">
      <iframe
        ...
        // invert yalnızca koyu temada: açık temada harita ters (negatif)
        // görünüyordu. Hover'da filtre tamamen kalkıyor.
        className="grayscale contrast-125 dark:invert-[.9] transition-all duration-1000 group-hover:grayscale-0 group-hover:invert-0 group-hover:contrast-100"
