...
const SectionWithMockup: React.FC<SectionWithMockupProps> = ({ title, description, badge }) => {
  return (
    <section className="relative bg-white dark:bg-black overflow-hidden py-28 md:py-40">
      ...
      {/* Ambient glows */}
      <div className="pointer-events-none absolute -top-40 -left-40 w-[640px] h-[640px] rounded-full bg-[#E35205]/[0.06] " />
      <div className="pointer-events-none absolute -bottom-40 -right-40 w-[480px] h-[480px] rounded-full bg-[#A03500]/[0.08] " />
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 md:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            {/* Red glow */}
            <div className="absolute bottom-0 left-1/4 w-1/2 h-16 bg-[#E35205]/15  rounded-full pointer-events-none" />
          </motion.div>
          ...
          >
            ...
            <motion.div
              variants={fadeUp}
              custom={3}
              className="h-px w-full bg-gradient-to-r from-[#E35205]/30 via-white/10 to-transparent"
            />
            ...
            >
              {stats.map(({ icon: Icon, value, label }) => (
                <motion.div
                  key={label}
                  variants={fadeUp}
                  className="group relative flex flex-col gap-3 p-5 rounded-2xl border border-black/[0.07] dark:border-white/[0.07] bg-black/[0.03] dark:bg-white/[0.03] hover:border-[#E35205]/30 hover:bg-[#E35205]/[0.04] transition-all duration-300 cursor-default"
                >
                  ...
                  <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-br from-[#E35205]/5 to-transparent pointer-events-none" />
                </motion.div>
              ))}
              ...
              <motion.div
                variants={fadeUp}
                className="col-span-2 group relative flex flex-col gap-3 p-5 rounded-2xl border border-black/[0.07] dark:border-white/[0.07] bg-black/[0.03] dark:bg-white/[0.03] hover:border-[#E35205]/30 hover:bg-[#E35205]/[0.04] transition-all duration-300 cursor-default"
              >
                <div className="w-9 h-9 rounded-xl bg-[#E35205]/10 flex items-center justify-center group-hover:bg-[#E35205]/20 transition-colors">
