        ...
        <div className="flex flex-col items-center text-center">
          ...
          >
            <button
              ...
              className="group relative inline-flex items-center gap-3 px-10 py-5 rounded-full bg-[#E35205] text-white font-medium transition-all hover:scale-105 active:scale-95 shadow-[0_0_20px_rgba(227,82,5,0.3)] hover:shadow-[0_0_30px_rgba(227,82,5,0.5)]"
            >
          ...
          <AnimatePresence>
            {showForm && (
              ...
              >
                <div className="bg-white dark:bg-[#0a0514] border border-[#E35205]/20 rounded-3xl p-8 shadow-[0_0_60px_rgba(227,82,5,0.15)] text-left">
                  {sent ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <button
                        type="submit"
                        disabled={loading}
                        className="w-full inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-[#E35205] hover:bg-[#A03500] disabled:opacity-40 text-white font-semibold text-sm transition-all hover:scale-[1.02] active:scale-95"
                      >
