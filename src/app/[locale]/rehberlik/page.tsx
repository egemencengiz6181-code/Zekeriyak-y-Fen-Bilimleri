...
function SectionCard({ section, index }: { section: SectionItem; index: number }) {
  ...
  return (
    <Reveal as="div" className="relative rounded-3xl">
      <div
...
export default function RehberlikPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      {/* ambient glows */}
      <div className="fixed top-[-80px] left-1/2 -translate-x-1/2 w-[900px] h-[600px] bg-[#12648f]/8 rounded-full glow-soft pointer-events-none -z-10" />
      <div className="fixed top-[40%] right-[-80px] w-[500px] h-[500px] bg-[#ec2027]/5 rounded-full glow-soft pointer-events-none -z-10" />
      <div className="fixed bottom-0 left-[-80px] w-[400px] h-[400px] bg-[#12648f]/5 rounded-full glow-soft pointer-events-none -z-10" />
      ...
      <section className="relative min-h-[85vh] flex items-center pt-32 pb-20 px-6">
        <div className="max-w-6xl mx-auto w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <div className="enter-up inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#12648f]/30 bg-[#12648f]/[0.08] mb-8">
              ...
              <p className="enter-up text-base text-slate-500 dark:text-white/50 font-light leading-relaxed mb-10 max-w-lg">
              ...
              <div className="enter-up flex flex-wrap gap-4">
                <Link
                  href="/contact"
            ...
            <div className="enter-up relative">
